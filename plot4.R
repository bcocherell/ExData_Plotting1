plot4 <- function() {
  ...
  # use sqldf to read it in, keeping only the rows where the date is either 2/1/2007 or 2/2/2007
  hpc.df <- sqldf("select * from hpc where Date in ('1/2/2007', '2/2/2007')")
  ...
  # create plot, saving to plot4.png file in working directory
  ...
  with(hpc.df, {
    ...
    legend("topright", lty = "solid", bty = "n", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_1", "Sub_metering_2"))
